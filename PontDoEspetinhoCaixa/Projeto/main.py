...
def msg_suporte(mensagem):
    ...
    server.ehlo()
    server.starttls()
    user = "pointespetinhosousa@gmail.com"
    senha = "123point456"
    para = "ejrgeek@gmail.com"
    msg = mensagem
...
class PedidosApp(Screen):
    ...
    def ver_pedidos(self):
        conn = sql.connect("C:/Users/ejrfl/Dropbox/bd_pointEsp/pointesp.db")
        cursor = conn.cursor()
...
class PedidoAltDelApp(Screen):
    ...
    def imprimir_pedido(self):
        ...
        arq = open("C:/Users/ejrfl/Dropbox/bd_pointEsp/arqPedidosImprimir/nota.txt", "w")
        assert isinstance(bannerNota, object)
        arq.writelines(bannerNota)
        arq.close()
        web.open("file:///C:/Users/ejrfl/Dropbox/bd_pointEsp/arqPedidosImprimir/nota.txt")
